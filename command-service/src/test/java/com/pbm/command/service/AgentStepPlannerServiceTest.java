...
class AgentStepPlannerServiceTest {
    ...
    @Test
    @DisplayName("AI planner가 유효한 target을 반환하면 rule-based보다 우선 적용한다")
    ...
    @Test
    @DisplayName("AI planner가 SCROLL을 반환하면 scroll instruction을 생성한다")
    ...
    @Test
    @DisplayName("직전 ELEMENT_NOT_FOUND 실패와 screenshot이 있으면 vision planner 좌표 클릭을 사용한다")
