...
from app.schemas.aliexpress import AliexpressCategoryResponse, AliexpressSearchResponse
from app.services.aliexpress_service import get_affiliate_categories, search_affiliate_products
