...
class NaverShoppingControllerTest {
    ...
    void searchProducts_success_returns200WithApiResponse() throws Exception {
        ...
        List<SearchResponse> mockResults = List.of(
                new SearchResponse("에어팟 프로", "250000", "350000", "애플스토어", "https://example.com/1", "https://img.example.com/1.jpg", "KRW", "naver-1"),
                new SearchResponse("갤럭시 버즈", "120000", "180000", "삼성스토어", "https://example.com/2", "https://img.example.com/2.jpg", "KRW", "naver-2")
        );
