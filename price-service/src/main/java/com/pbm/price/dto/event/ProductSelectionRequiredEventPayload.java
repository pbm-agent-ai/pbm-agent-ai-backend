 ...
 *       Kafka 메시지 페이로드로 직렬화하여 command-service로 전달한다.
 *       검색 결과가 여러 개여서 사용자 선택이 필요한 경우 candidates에 후보 목록을 포함한다.
 * 연관: ProductSelectionRequiredEvent, ProductSelectionRequiredEventPublisher,
 *       command-service consumer, ProductCandidateDto.
 */
